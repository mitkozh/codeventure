...
public class SettingsServiceTest {
    ...
    private static final java.nio.file.Path PROPERTIES_PATH = Paths.get("level.properties");
    private static final java.nio.file.Path BACKUP_PATH = Paths.get("level.properties.bak");
