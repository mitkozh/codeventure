package com.codeventure.gui.screen;

import java.util.Objects;

import com.codeventure.controller.HelpScreenController;
...
public class HelpScreen extends AbstractScreen {
        ...
        try {
            codeEditorImage.setImage(new Image(Objects.requireNonNull(
                    getClass().getResourceAsStream(
                            "/com/codeventure/assets/images/code_editor_pic.png"))));
        } catch (Exception e) {
    ...
    private VBox createTileTypesSection() {
        ...
        ImageView floorImage = createTileImage(
                "/com/codeventure/assets/images/tiles/normal_tile.png");
        ...
        ImageView doorOpenedImage = createTileImage(
                "/com/codeventure/assets/images/tiles/door_opened.png");
        ...
        ImageView doorClosedImage = createTileImage(
                "/com/codeventure/assets/images/tiles/door_closed.png");
    ...
    private VBox createFeedbackSection() {
        ...
        try {
            positiveFeedbackImage.setImage(new Image(Objects.requireNonNull(
                    getClass().getResourceAsStream(
                            "/com/codeventure/assets/images/sucess_feedback_screen.png"))));
        } catch (Exception e) {
        ...
        try {
            negativeFeedbackImage.setImage(new Image(Objects.requireNonNull(
                    getClass().getResourceAsStream(
                            "/com/codeventure/assets/images/non-sucess_feedback_screen.png"))));
        } catch (Exception e) {
    ...
    protected String getCssPath() {
        return "/com/codeventure/assets/css/helpStyle.css";
    }
}