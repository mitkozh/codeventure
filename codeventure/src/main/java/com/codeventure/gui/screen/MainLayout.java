...
import com.codeventure.service.navigator.MainLayoutNavigatorManager;
import com.codeventure.utils.ConstantsResources;
...
public class MainLayout extends AbstractScreen {
    ...
    protected String getFontPath() {
        return "/com/codeventure/assets/fonts/PixelifySans_Regular.ttf";
    }
    ...
    protected String getCssPath() {
        return "/com/codeventure/assets/css/styles.css";
    }
