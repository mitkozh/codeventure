...
class ExecutionObservablesTest {
    ...
    void testSetExecutionCompletedUpdatesProperties() {
        ...
        assertEquals(message, completionMessage.get(), "CompletionMessage property should match set message");
    }
    ...
    void testResetFlagsClearsProperties() {
        ...
        BooleanProperty executionStarted = executionObservables.executionStartedProperty();
        StringProperty completionMessage = executionObservables.completionMessageProperty();
        assertFalse(executionCompleted.get(), "ExecutionCompleted should be false after reset");
        assertFalse(executionStarted.get(), "ExecutionStarted should be false after reset");
        assertEquals("", completionMessage.get(), "CompletionMessage should be empty after reset");
    }

    @Test
    void testInitialState() {
        assertFalse(executionObservables.executionCompletedProperty().get(), "Initial ExecutionCompleted should be false");
        assertFalse(executionObservables.executionStartedProperty().get(), "Initial ExecutionStarted should be false");
        assertEquals("", executionObservables.completionMessageProperty().get(), "Initial CompletionMessage should be empty");
    }
}