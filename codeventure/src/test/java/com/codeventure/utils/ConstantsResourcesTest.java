...
public class ConstantsResourcesTest {
    ...
    void testGeometricBackground() {
        String expected = 
            "/com/codeventure/assets/images/geometric_background.png";
    ...
    @Test
    void testGameBezel() {
        String expected = "/com/codeventure/assets/images/game_bezel.png";
    ...
    void testBackgroundImage() {
        String expected = "/com/codeventure/assets/images/background.jpg";
